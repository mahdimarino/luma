        ...
        <div className={`section section-padding-t90-b100 ${SectionBgColor}`}>
            <div className="container">
                <SectionTitle
                    ...
                    subTitle="At Luma Demand, we prioritize team well-being through regular outings, fun Fridays, and recognition programs, fostering a positive and lively office atmosphere."
                />
