            ...
            <div className="container">
                <div className="row mb-lg-14 mb-md-10 mb-6">
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 col-12 mb-6">
                        <div className="footer-widget">
                            <div className="footer-logo">
                                <Logo 
                                    image={`https://mahdismahi.com/ddmicons/ddmlogo.png`}
                                />
                            </div>
                    ...
                    {FooterData && FooterData.map((single, key) => {
                            return(
                                <div key={key} className="col-xl-2 col-lg-2 col-md-2 col-sm-6 col-6 mb-6">
                ...
                <div className="row">
                    <div className="col">
                        <p className="copyright">&copy; {new Date().getFullYear()} <strong>Copyright</strong> - All Rights Reserved</p>
                    </div>
                </div>
